...
<div class="form-group">
    ...
    <input type="text" class="form-control" id="course_author" name="course_author" value="<?php if(isset($row["course_author"])) {echo $row["course_author"];} ?>"></input>
</div>

<div class="form-group">
    <label for="course_duration">Course Duration</label> 
    <input type="text" class="form-control" id="course_duration" name="course_duration" value="<?php if(isset($row["course_duration"])) {echo $row["course_duration"];} ?>"></input>
</div>

<div class="form-group">
    <label for="course_original_price">Course Original Price</label> 
    <input type="text" class="form-control" id="course_original_price" name="course_original_price" value="<?php if(isset($row["course_original_price"])) {echo $row["course_original_price"];} ?>"></input>
</div>

<div class="form-group">
    <label for="course_price">Course Selling Price</label> 
    <input type="text" class="form-control" id="course_price" name="course_price" value="<?php if(isset($row["course_price"])) {echo $row["course_price"];} ?>"></input>
</div>
